...
SWIFT_CLASS("_TtC14SudarshanKriya17AumViewController")
@interface AumViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC14SudarshanKriya23BhastrikaViewController")
@interface BhastrikaViewController : UIViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, copy) NSDictionary<NSString *, NSString *> * _Null_unspecified tutorialDict;
@property (nonatomic, copy) NSString * _Null_unspecified tutorialText;
...
SWIFT_CLASS("_TtC14SudarshanKriya20FinishViewController")
@interface FinishViewController : UIViewController <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC14SudarshanKriya18MenuViewController")
...
SWIFT_CLASS("_TtC14SudarshanKriya24OnboardingViewController")
@interface OnboardingViewController : UIPageViewController <UIPageViewControllerDataSource>
...
SWIFT_CLASS("_TtC14SudarshanKriya18RestViewController")
...
SWIFT_CLASS("_TtC14SudarshanKriya19SohamViewController")
@interface SohamViewController : UIViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC14SudarshanKriya19UjayiViewController")
@interface UjayiViewController : UIViewController <AVAudioPlayerDelegate>
@property (nonatomic, strong) AVAudioPlayer * _Nullable player;
@property (nonatomic, copy) NSURL * _Nullable playURL;
- (void)viewDidLoad;
- (void)playSound:(NSURL * _Nonnull)url;
...
SWIFT_CLASS("_TtC14SudarshanKriya21WelcomeViewController")
